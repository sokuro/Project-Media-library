...
public class ConcertVideo extends Audio {
	...
	//2nd Constructor
	public ConcertVideo(String aTitle, String aArtist, String aProducer, String aGenre, String aLanguage, 
			int aYear, double aLength, double aSize, String aFormat, String aImage, String aConVideo) {
