...
public class BluRay extends Video {
	...
	private final StringProperty threeDproperty;

	/*
	 * Constructor
	 */
	public BluRay() {
		this(null, null, null, null, null, null, null, 0, 0, 0, null, null, null, null);
	}
	
	//2nd Constructor
	public BluRay(String aTitle, String aActor, String aDirector, String aProducer,
			String aGenre, String aLanguage, String aAudience, int aYear, double aSize,
			double aLength, String aFormat, String aThreeD, String aImage, String aVideo) {
		...
		this.threeDproperty = new SimpleStringProperty(this.getThreeD());
	}
	...
	//variable: threeD
	public void setThreeD(String aThreeD) {
		this.threeD = aThreeD;
	}
	public String getThreeD() {
		return this.threeD;
	}
	public void setPropertyThreeD(String threeDproperty) {
		this.threeDproperty.set(threeDproperty);
	}
	public StringProperty getPropertyThreeD() {
		return this.threeDproperty;
	}
	
	public void print() {
		super.print();
		System.out.println("Video 3D compatible: " + getThreeD());
	}
