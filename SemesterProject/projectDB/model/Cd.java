...
public class Cd extends Audio {
	...
	//2nd Constructor
	public Cd(String aTitle, String aArtist, String aProducer, String aGenre, String aLanguage, 
		...
		this.audio = new SimpleStringProperty(super.getMedia());
	}
	...
	//variable: audio
	public void setPropertyMedia(String aAudio) {
		this.image.set(aAudio);
	}
